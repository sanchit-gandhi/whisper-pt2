...
from modeling_whisper_attn import WhisperFlashAttnForConditionalGeneration
...
def parse_args():
    ...
    parser.add_argument(
        "--use_torch_compile",
        action="store_true",
        help="Whether to use Torch 2.0 compilation.",
    )
    parser.add_argument(
        "--output_csv_file",
        type=str,
...
def main():
    ...
    whisper_cls = WhisperFlashAttnForConditionalGeneration if args.use_flash_attn else WhisperForConditionalGeneration
