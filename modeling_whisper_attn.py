...
# Copied from transformers.models.whisper.modeling_whisper.WhisperForConditionalGeneration with WhisperForConditionalGeneration->WhisperFlashAttnForConditionalGeneration
class WhisperFlashAttnForConditionalGeneration(WhisperPreTrainedModel):
    base_model_prefix = "model"
