...
class WhisperAttention(nn.Module):
    ...
    # Copied from transformers.models.whisper.modeling_whisper.WhisperAttention.__init__
    def __init__(
        self,
        embed_dim: int,
        num_heads: int,
...
# Copied from transformers.models.whisper.modeling_whisper.WhisperForConditionalGeneration with WhisperForConditionalGeneration->WhisperCPUOffloadForConditionalGeneration
class WhisperCPUOffloadForConditionalGeneration(WhisperPreTrainedModel):
    base_model_prefix = "model"
    ...
    def enable_model_cpu_offload(self, gpu_id=0):
        ...
        `enable_sequential_cpu_offload`, but performance is much better due to the iterative execution of the decoder.
        """
        ...
        hook = None
        for cpu_offloaded_model in [self.model.encoder, self.model.decoder]:
